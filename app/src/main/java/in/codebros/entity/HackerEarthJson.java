...
public class HackerEarthJson implements Serializable
{
    
String  title,description, url ,subscribe, status ,college,date , time , end_date ,
        end_time , start_timestamp ,end_timestamp , start_tz, end_tz, start_utc_tz,end_utc_tz ,cover_image, thumbnail , is_hackerearth,challenge_type;
